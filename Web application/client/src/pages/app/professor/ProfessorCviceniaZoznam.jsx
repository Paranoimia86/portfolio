...
import "./ProfessorCviceniaZoznam.css";

export default function ProfessorExercisesList() {
  ...
  return (
    <div className="professor-exercises-list">
      <h1>{t("professor.myExercises")}</h1>
      <div className="excercise-container">
        {weeks.map((week) => (
          <div key={week} className="exercise-card">
            ...
            <button
              ...
              onClick={() => navigate(`/professor/cvicenia/${week}`)}
            >
              <svg
